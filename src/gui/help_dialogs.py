...
class AboutDialog(BaseInfoDialog):
    def __init__(self, parent=None):
        content = """
        <h3>Lufia 2 Manual Tracker v1.4.3</h3>
        ...
        Ported to Manual Tracker v1.4.3 (PyQt6) @2026</p>
        """
...
class HelpDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.add_page("Introduction", """
            <h3>Welcome to RndmMeme's Lufia 2 Manual Tracker v1.4.3!</h3>
        ...
        self.add_page("Map & Items", """
            ...
            <ul>
                <li>Use <b>Custom &gt; City Color</b> to adjust the default color of unconquered cities.</li>
