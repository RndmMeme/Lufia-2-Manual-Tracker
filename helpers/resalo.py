...
class Reset:
    ...
    def reset(self):
        ...
        self.app.item_canvas.create_text(10, 10, anchor="w", text="Items / Spells:", fill="white", font=("Arial", 13), tags=("item_canvas_label",))
...
class Save():
    ...
    def get_item_data(self, item_canvas):
        ...
        for text_id, button_id, y, entry_height, item_name, location in item_entries:
            ...
            print(f"item_entries: {item_entries}")
        return item_data
        ...
        for character in character_data:
            ...
            if name in self.app.character_images:
                ...
                if obtained is not None:
                    ...
                    print(f"Obtained ist None für {name}")
            else:
                print(f"FEHLER: Charakter {name} NICHT im character_images gefunden!")
            ...
            if character["type"] == "location_assignment":
                ...
                if name in self.app.character_images and obtained is not None:
                    ...
                    try:
                        ...
                        print(f"image_id des charakters {name}: {image_id}")
                        ...
                        if obtained and location: #Stelle sicher, dass die Koordinaten und die Location vorhanden sind
                            ...
                            for word in words:
                                if len(word) > max_line_length and len(word) > 3:
                                    ...
                                    print(f"Hyphenated Word: {hyphenated_word}") #Debug
                            ...
                            print("mini_image_coords oder location sind nicht vorhanden")
    ...
    def set_maidens_canvas(self, maiden_data):
        ...
        for maiden in maiden_data:
            ...
            if name in self.app.maiden_images:
                ...
                print(f"FEHLER: Charakter {name} NICHT im maiden_images gefunden!")
                ...
                for data in game_state.get("characters_canvas", []):
                    ...
                    if data["type"] == "location_assignment":
                        ...
                        for char_name, char_data in self.app.character_images.items():
                            ...
                            print(f"Prüfe Charakter: {char_name}, Daten: {char_data}")
                                ...
                                if data.get("type") == "location_assignment":
                                    ...
                                    if data.get("name") == char_name:  # Korrekter Vergleich: Charaktername
                                        ...
                                        if "image_id" in char_data:
                                            ...
                                            print(f"Image_id für {char_name}: {char_data['image_id']} , {location} gefunden. Rufe make_draggable auf.")
                                            
                                            from gui_setup import make_draggable, assign_character_to_location, remove_character_location

                                            print(f"aufrufen von make_draggable mit {char_name}")

                                            make_draggable(self.app.canvas, char_data["image_id"])
                                            print(f"initialisieren des tag_bind")
                                            
                                            self.app.characters_canvas.tag_bind(
                                                char_data['position'],
                                                "<Button-3>",
                                                lambda event, loc_images=self.app.location_character_images: (
                                                    print(f"Lambda-Funktion aufgerufen, location character images: {loc_images}"),
                                            ...
                                            print(f"Keine Image_id für {char_name} gefunden.")

                                    else:

                                        print(f"Kein passender Charakter für {char_name} im Game State gefunden")

                                else:

                                    print(f"Kein Location Assignment")


                        print("Schleife zur Zuordnung der Image-IDs beendet")
